...
object  DataDummy {
    fun moviesData(): List<MovieEntity> = listOf(
        ...
        MovieEntity(
            ...
            "https://media.comicbook.com/2017/12/new-black-panther-movie-poster-2018--1064120.jpg",
    ...
    fun tvShowData(): List<MovieEntity> = listOf(
        ...
        MovieEntity(
            ...
            "Sci-fi",
            5.0,
            "The series will follow the royal family of Inhumans, led by their King, Black Bolt (Anson Mount), after they are split up by a military coup and end up in Hawaii in the latest television series set in the Marvel Cinematic Universe.",
        ...
        MovieEntity(
            ...
            "Superhero",
            6.7,
            "This live-action interracial romance follows Tandy Bowen and Tyrone Johnson, two teenagers from very different backgrounds, who find themselves burdened and awakened to newly acquired superpowers while falling in love. Tandy can emit light daggers and Tyrone has the ability to engulf others in darkness.",
        ...
        MovieEntity(
            ...
            "Drama",
            7.9,
            "Plot. Jessica Jones is a super-powered woman who had a brief superhero career until an incident in which the villainous Kilgrave caused her to kill someone. After that incident, she became a private investigator. When Kilgrave resurfaces, Jessica must rise up to stop him.",
        ...
        MovieEntity(
            ...
            "Action/fiction",
            7.3,
            "Luke Cage, a former convict with superhuman strength and unbreakable skin, keeps a low profile as a sweeper at ex-gangster Henry \"Pop\" Hunter's barbershop, and as a dishwasher at crime boss Cornell \"Cottonmouth\" Stokes' nightclub, Harlem's Paradise.",
        ...
        MovieEntity(
            ...
            "Superhero",
            7.0,
            "Runaways is a superhero comic book series published by Marvel Comics. The series features a group of teenagers who discover that their parents are part of an evil crime organization known as \"Pride\". ... Originally, the series featured a group of six kids whose parents routinely met every year for a charity event.",
            "https://images-na.ssl-images-amazon.com/images/I/71VXEY33YtL._AC_SL1000_.jpg",
            "https://youtu.be/y-OJVwUG76k"
        )
    )

    fun remoteDummyMovies(): List<MovieResponse> = listOf(
        MovieResponse(
            "MOV1",
            "movie",
            "Avengers: Endgame",
    ...
    fun remoteDummyTvShows(): List<MovieResponse> = listOf(
        MovieResponse(
            "TVS1",
            "tv-show",
            "Agents of S.H.I.E.L.D.",
